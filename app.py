...
@app.post("/analytics/human_handover", tags=["analytics"])
...
@app.get("/analytics/human_handover", tags=["analytics"])
...
@app.post("/analytics/chatbot_close", tags=["analytics"])
...
@app.post("/analytics/session_end", tags=["analytics"])
