...
const HealthcareAIWidget = {
  init: (userConfig = {}) => {
    ...
    if (config.showButton) {
      ...
      if (existingButton) {
        console.log("Found existing button with id 'elan-ai-button', will use it instead of creating a new one");
    ...
    if (config.showGreeting && !document.getElementById("healthcare-ai-greeting")) {
